        ...
        <main class="tsp-dash-content-area flex-grow-1 p-4 bg-light">
            <div class="container-fluid p-0" style="max-width: 800px;">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-secondary mb-0 small fw-semibold" style="font-size: 1.3rem;">अपनी पूर्व घोषणा में सुधार करें।</p>
                </div>
                        ...
                        <form action="<?= admin_path('announcements/' . $announcement['id'] . '/edit') ?>" method="post">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="content" name="content" rows="8" required 
                                          placeholder="यहाँ अपनी सूचना का पूरा विवरण विस्तार से लिखें..." style="border-color: #cbd5e1; font-size: 1.3rem; resize: vertical;"><?= htmlspecialchars($announcement['content']) ?></textarea>
                            </div>

                            <div class="mb-4 form-check form-switch d-flex align-items-center gap-3">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" 
                                       <?= (int) $announcement['is_active'] === 1 ? 'checked' : '' ?> 
                                ...
                                <label class="form-check-label fw-semibold text-secondary" for="is_active" style="font-size: 1.25rem; cursor: pointer; user-select: none;">
                                    सूचना सक्रिय रखें (छात्रों को दिखाएं)
                                </label>
                            </div>
